...
format:
  html:
    include-in-header:
      - text: |
          <script src="files/htmlwidgets-0.6/htmlwidgets.js"></script>
          <link href="files/plotlyjs-1.10.1/plotly-htmlwidgets.css" rel="stylesheet" />
          <script src="files/plotlyjs-1.10.1/plotly-latest.min.js"></script>
          <script src="files/plotly-binding-3.6.0/plotly.js"></script>
---

::: {.callout-important}
# Important!

None of this code is generated automatically—it's all [static R output from my old notebook](https://notebook.andrewheiss.com/project/diss-ingos-in-autocracies/survey-completion-rates/). None of the file paths are accurate here. The code and output here are included for historical purposes.
:::
