...
None of this code is generated automatically—it's all [static R output from my old notebook](https://notebook.andrewheiss.com/project/diss-ingos-in-autocracies/survey-countries/). None of the file paths are accurate here. The code and output here are included for historical purposes.
:::
